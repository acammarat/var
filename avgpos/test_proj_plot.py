...
Usage: python3 test_proj_plot.py
"""
...
# Read data from file
data = np.loadtxt('test_proj.dat', dtype=str)
...
# Save figure
plt.tight_layout()
plt.savefig('test_proj_heatmap.png', dpi=150, bbox_inches='tight')
print(f"Plot saved to test_proj_heatmap.png")
